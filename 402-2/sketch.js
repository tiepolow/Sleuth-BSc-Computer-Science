...
Officer: 7311170
CaseNum: 402-2-63459589-7311170
...
function draw()
{
    ...
    if ((det.locationX == 690) && (det.locationY == 73)) {
        det.speedX = 0;
        det.speedY = 1;
    }
    if (det.locationX == 690 && det.locationY == 320){
        det.speedX = -1;
        det.speedY = 0;
    }
    if (det.locationX == 390 && det.locationY == 320){
        det.speedX = 0;
        det.speedY = 1;
    }
    if (det.locationX == 390 && det.locationY == 440){
        det.speedX = -1;
        det.speedY = 0;
    }
    if (det.locationX == 195 && det.locationY == 440){
        det.speedX = 0;
        det.speedY = 1;
    }
    if (det.locationX == 195 && det.locationY == 630) {
        det.speedX = -1;
        det.speedY= 0;
    }
