...
Officer: 7311170
CaseNum: 402-3-36822066-7311170
...
function draw()
{
    ...
    if (det.locationX < 210 && det.locationY == 130){
        det.speedX = 1;
        det.speedY = 0;
    }
    if (det.locationX == 700 && det.locationY ==130) {
        det.speedX = 0;
        det.speedY = 1;
    }
    ...
    if (det.locationX == 260 && det.locationY == 255){
        det.speedX = 0;
        det.speedY = 1;
    }
    if (det.locationX == 260 && det.locationY == 445) {
        det.speedX = 1;
        det.speedY = 0;
    }
    if (det.locationX == 825 && det.locationY == 445) {
        det.speedX = 0;
        det.speedY = 1;
    }
    if (det.locationX == 825 && det.locationY == 570) {
        det.speedX = -1;
        det.speedY = 0;
    }
    if (det.locationX == 450 && det.locationY == 570){
        det.speedX = 0;
        det.speedY = 1;
    }
    if (det.locationX == 450 && det.locationY == 633) {
        det.speedX = 1;
        det.speedY = 0;
    }
    if (det.locationX == 760 && det.locationY == 633) {
        det.speedX = 0;
        det.speedY = 1;
    }
